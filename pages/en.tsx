      ...
      >
        <div className="inline-block max-w-3xl text-center justify-center relative">
          ...
          <span className={title({ size: 'lg' })}>
            Victoria Malykhina — Project & Sales Manager&nbsp;
          </span>
          <br />
          <span className={subtitle({ class: 'mt-4' })}>
            <strong className="font-semibold">1,153</strong> projects in 3 years ·{' '}
            <strong className="font-semibold">₽75M</strong> revenue · up to{' '}
            <strong className="font-semibold">200</strong> projects in parallel ·{' '}
            <strong className="font-semibold">86%</strong> conversion
          </span>
        </div>
        ...
        <section id="about" className="w-full max-w-5xl">
          <div className="rounded-xl border border-default-200/50 bg-content1 p-6">
            <div className="space-y-3 text-default-700 leading-7">
              <p>
                Hello! I’m Victoria — a project manager with a commercial background and a passion
                for clear processes. Over 3 years, I delivered 1,153 projects with ₽75M revenue,
                handling up to 200 cases in parallel and keeping an 86% conversion rate.
              </p>
              <p>
                I turn chaos into a clear path: from lead and site measurement to design, estimate,
                delivery and installation. I combine visual taste (Ceramic 3D, Figma, Tilda) with a
                love for numbers: +₽3.6M to plan in 8 months, +23.4% revenue, x1.5 average check.
                The driver — standardization: the accessory table (scaled nationwide), a loyalty
                calculator with smart suggestions, and the “Always Handy” idea for the cart.
              </p>
              <p>
                I value empathy, transparent agreements, and on‑time delivery. I resolve
                escalations, negotiate with contractors, and teach teams via checklists and simple
                internal tools. Target roles: Project/Account/CSM in digital/interior/travel/e‑com;
                also open to Junior PM/BA or UX/UI — I learn fast and aim for measurable impact.
              </p>
              <p>
                Let’s talk about how my toolkit and approach can strengthen your team. The fastest
                way to reach me is on Telegram:{' '}
                <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="rounded-xl border border-default-200/50 bg-content1 p-6 hover-card">
              ...
              <p className="text-default-700 mt-1">
                MSc in Business Development and Innovation, 2023
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-xl border border-default-200/50 bg-content1 p-6 hover-card">
              ...
              <div className="text-default-500 mb-3">
                Jul 2022 — Aug 2025 · Project Sales Specialist
              </div>
              <ul className="list-disc ml-5 space-y-1 text-default-700">
                <li>
                  End‑to‑end projects: lead → measurement → design → estimate → delivery →
                  installation
                </li>
                <li>
                  Ceramic 3D design, material selection, on‑time delivery and contractor
                  coordination
                </li>
                <li>
                  Site visits to new builds; participation in the &quot;Novosel&quot; client program
                </li>
                <li>
                  Loyalty calculator: points calculation and smart prompts for high‑cashback items
                </li>
                <li>
                  UX idea “Always Handy” (tape, gloves, knife, etc.) — increases average check and
                  lines
                </li>
              </ul>
            </div>
