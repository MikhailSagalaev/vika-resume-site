    ...
    <div className="print-container">
      <header className="mb-6">
        ...
        <p className="text-sm text-default-600">
          1 153 проектов · 75 млн ₽ · до 200 одновременно · конверсия 86%
        </p>
      </header>
      ...
      <section className="mb-4">
        ...
        <p className="mt-1 text-sm leading-6">
          Менеджер проектов с сильным коммерческим бэкграундом и клиентским сервисом. Запускаю
          инструменты, которые масштабируются по сети (таблицы-сопровождения, калькуляторы
          лояльности), повышаю выручку и эффективность.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <div className="mt-1">
          <h3 className="font-medium">
            Ле Монлид / Леруа Мерлен Восток — Специалист по продажам проектов
          </h3>
          ...
          <ul className="text-sm leading-6 list-disc ml-5">
            ...
            <li>
              Дизайн (Ceramic 3D), подбор материалов, выполнение в срок и взаимодействие с
              подрядчиками
            </li>
      ...
      <section className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <ul className="mt-1 text-sm leading-6 list-disc ml-5">
            ...
            <li>
              СКФУ, Ставрополь — Управление развитием бизнеса и инновациями, Магистратура, 2023
            </li>
      ...
      <section className="mt-6">
        ...
        <p className="text-sm leading-6">
          Telegram: @mal_ina_victoria · Email: mal_ina-victoria@mail.ru
        </p>
      </section>
    </div>
  );
