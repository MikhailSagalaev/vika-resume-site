      ...
      >
        <div className="inline-block max-w-3xl text-center justify-center relative">
          ...
          <span className={subtitle({ class: 'mt-4' })}>
            <strong className="font-semibold">1 153</strong> проектов за 3 года ·{' '}
            <strong className="font-semibold">75 млн ₽</strong> оборота · одновременно до{' '}
            <strong className="font-semibold">200</strong> проектов · конверсия{' '}
            <strong className="font-semibold">86%</strong>
          </span>
        </div>
        ...
        <section id="about" className="w-full max-w-5xl">
          <div className="rounded-xl border border-default-200/50 bg-content1 p-6">
            <div className="space-y-3 text-default-700 leading-7">
              <p>
                Привет! Меня зовут Вика. Я проектный менеджер с коммерческим бэкграундом и любовью к
                понятным процессам. За 3 года я сопроводила 1 153 проекта на сумму 75 млн ₽, вела
                одновременно до 200 кейсов и держала конверсию 86%.
              </p>
              <p>
                Мне нравится превращать хаос в ясный путь: от заявки и замера до дизайна, сметы,
                поставки и установки. Я сочетаю вкус к визуалу (Ceramic 3D, Figma, Tilda) и
                дисциплину к цифрам: +3,6 млн ₽ к плану за 8 месяцев, +23,4% оборота, чек x1,5. Эти
                результаты дала стандартизация: таблица сопутствующих (масштабирована на регионы),
                калькулятор лояльности с подсказками выгодных позиций и идея «Всегда пригодится» для
                корзины.
              </p>
              <p>
                Ценю эмпатию к клиенту, прозрачные договорённости и работу в срок. Умею решать
                спорные ситуации, договариваться с подрядчиками и обучать коллег через чек‑листы и
                простые инструменты. Вижу себя в ролях Project/Account/CSM в
                digital/interior/travel/e‑com, также открыта к Junior PM/BA или UX/UI — быстро учусь
                и люблю доводить решения до измеримого эффекта.
              </p>
              <p>
                Буду рада познакомиться и обсудить, как мои инструменты и подход могут усилить вашу
                команду. Связаться удобно в Telegram:{' '}
                <a
          ...
          {certificates && certificates.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {certificates.map((name) => (
                ...
                >
                  <span className="text-default-700">{name.replace(/\.[^/.]+$/, '')}</span>
                  <span className="px-2 py-1 text-xs rounded-full bg-content2 text-foreground">
                    PDF/Doc
                  </span>
                </a>
              ))}
        ...
        <div className="grid w-full max-w-5xl grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Reveal delay={0.05}>
            <InteractiveCard
              borderFrom="from-violet-500"
              borderTo="to-sky-400"
              spotColor="rgba(99,102,241,0.22)"
            >
              <div className="text-3xl font-semibold">
                x<Counter to={1.5} decimals={1} />
              </div>
          ...
          <Reveal delay={0.1}>
            <InteractiveCard
              borderFrom="from-emerald-500"
              borderTo="to-teal-400"
              spotColor="rgba(16,185,129,0.22)"
            >
              <div className="text-3xl font-semibold">
                +<Counter to={23.4} decimals={1} suffix="%" />
              </div>
        ...
        <section id="skills" className="w-full max-w-5xl">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span
                key={s}
                className="px-3 py-1 rounded-full bg-content2 text-foreground text-sm hover-chip"
              >
                {s}
              </span>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="rounded-xl border border-default-200/50 bg-content1 p-6 hover-card">
              ...
              <p className="text-default-700 mt-1">
                Управление развитием бизнеса и инновациями — Магистратура, 2023
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="metrics" className="w-full max-w-5xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              ...
              <div
                key={m.k}
                className="rounded-xl border border-default-200/50 bg-content1 p-4 hover-card"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-xl border border-default-200/50 bg-content1 p-6 hover-card">
              ...
              <div className="text-default-500 mb-3">
                Июл 2022 — Авг 2025 · Специалист по продажам проектов
              </div>
              <ul className="list-disc ml-5 space-y-1 text-default-700">
                <li>Проекты под ключ: лид → замер → дизайн → смета → поставка → монтаж</li>
                <li>
                  Дизайн в Ceramic 3D, подбор материалов, выполнение в срок и взаимодействие с
                  подрядчиками
                </li>
                <li>
                  Выезды на новостройки; участие в программе «Новосёл» для привлечения клиентов
                </li>
                <li>
                  Калькулятор лояльности: расчёт баллов и подбор позиций с повышенным кешбэком
                </li>
                <li>
                  Идея UX «Всегда пригодится» (скотч, перчатки, нож и т.д.) — рост среднего чека и
                  количества позиций (на согласовании)
                </li>
              </ul>
            </div>
            <div className="rounded-xl border border-default-200/50 bg-content1 p-6 hover-card">
              ...
              <div className="text-default-500 mb-3">
                Ноя 2021 — Фев 2022 · Ассистент экономиста
              </div>
              <ul className="list-disc ml-5 space-y-1 text-default-700">
        ...
        <section id="contacts" className="w-full max-w-5xl text-center">
          <p className="text-default-700">
            ...
            <a
              ...
              rel="noreferrer"
            >
              Telegram — @mal_ina_victoria
            </a>{' '}
            ·{' '}
            <a className="text-primary hover:underline" href="mailto:mal_ina-victoria@mail.ru">
